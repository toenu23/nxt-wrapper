module.exports = function(options) {
   ...
   */
  this.request('eventRegister', { remove: true }, function(data) {
    parent.request('eventRegister', {}, function(data) {
      parent.waitEvent();
    });
  });
  ...
  this.exit = function(force) {
    this.event.emit('exit', force);
  };

  this.event.on('exit', function() {
    options.eventLoop = false;
  });
